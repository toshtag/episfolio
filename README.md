...
🟢 **v0.7.0 リリース済（2026-05-03）** — `pnpm tauri dev` での開発ビルド動作確認済み。署名済の配布バイナリは未配布（v1.0 で対応予定）。
...
| Phase | 内容 |
|---|---|
| v0.5 | AI 壁打ち・下書き機能（信頼担保 UX 設計後に着手） |
| v0.8 | Markdown / JSON / PDF / DOCX エクスポート + 自動バックアップ |
| v0.9 | 暗号化 at rest（SQLCipher）+ Windows / Linux 対応 |
| v1.0 | 安定版（署名済バイナリ配布） |
